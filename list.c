...
struct list *
list_insert_before(struct list *list, struct list *before, void *data)
{
...
struct list *
list_delete(struct list *list, void *data)
{
	struct list **elemp;
...
struct list *
list_to_head(struct list *list, void *data)
{
	if (!data)
		return list;
...
struct list *
list_to_tail(struct list *list, void *data)
{
	if (!data)
		return list;
	list = list_delete(list, data);
...
struct list *
list_find(struct list *list, void *data)
{
	struct list *elem;
